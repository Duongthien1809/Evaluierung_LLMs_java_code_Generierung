...
def main():
    ...
    for prompt_file in find_files('./Daten/LeetCode/Referenzen/', specific_file_name="readme.md"):
    ...
    for code_file in find_files('./Daten/LeetCode/Referenzen/', file_exts=['Solution.java']):
    ...
    for test_file in find_files('./Daten/LeetCode/Tests/', file_exts=['SolutionTest.java']):
    ...
    # Zusammenführen der Daten basierend auf dem Verzeichnisnamen
    merged_results = []
