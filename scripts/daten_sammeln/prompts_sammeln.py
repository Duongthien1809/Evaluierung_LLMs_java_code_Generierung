...
def prompt_technik(raw_prompt: str):
    prompt = format_problem_statement(raw_prompt)['full_text']
    # Chain of Thought Prompting
    chain_of_thought_prompt = ChatPromptTemplate.from_messages(
        [
            SystemMessagePromptTemplate.from_template(
                """You are a helpful assistant that provides step-by-step reasoning to solve the problem.
                """
            ),
    ...
    tree_of_thought_prompt = ChatPromptTemplate.from_messages(
        [
            SystemMessagePromptTemplate.from_template(
                """You are a helpful assistant that explores multiple reasoning paths to solve the problem.
                """
            ),
            HumanMessagePromptTemplate.from_template(prompt),
        ]
    ...
    few_shot_prompt = ChatPromptTemplate.from_messages(
        [
            SystemMessagePromptTemplate.from_template(
                """You are a helpful assistant that uses examples to guide the solution.
                """
            ),
            HumanMessagePromptTemplate.from_template(prompt),
        ]
    ...
    zero_shot_prompt = ChatPromptTemplate.from_messages(
        [
            SystemMessagePromptTemplate.from_template(
                """You are a helpful assistant that solves the problem without any prior examples.
                """
            ),
            HumanMessagePromptTemplate.from_template(prompt),
        ]
    ...
    return {
        ...
        "tree_of_thought_prompt": tree_of_thought_prompt,
